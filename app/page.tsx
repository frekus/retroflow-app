      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-extrabold text-gray-900">Teams who own Monday morning</h2>
            <p className="mt-4 text-lg text-gray-500 max-w-xl mx-auto">
              Leaders who replaced manual metric reporting with RetroFlow.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              {
                quote: "Before RetroFlow, someone had to pull numbers from three different sheets every Monday and paste them into Slack. Now it just appears at 8 AM. Nobody misses the old way.",
                name: "Claire Dawson",
          ...
          <div className="border-t border-gray-100 pt-12">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10">
              {['Thornbury Group', 'Rova Capital', 'Waypoint Ventures', 'Ascend Ops', 'Lumen Advisory'].map((co) => (
